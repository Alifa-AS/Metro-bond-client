      ...
      <div className="container mx-auto py-12 px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="flex items-center space-x-4 bg-white dark:bg-gray-600 p-6 rounded-lg shadow-lg">
            <div className="flex items-center justify-center bg-pink-300 text-white 
          ...
          <div className="flex items-center space-x-4 bg-white dark:bg-gray-600 p-6 rounded-lg shadow-lg">
            <div className="flex items-center justify-center bg-pink-300 text-white h-16 w-16 md:h-24 md:w-24">
