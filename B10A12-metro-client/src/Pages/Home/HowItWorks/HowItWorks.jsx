...
const HowItWorks = () => {
    return (
        ...
        <div className="relative z-10 max-w-5xl w-full">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center py-6 px-5 md:px-10">
                ...
                <div className="w-full md:w-1/2 md:ml-10 text-left mt-6 md:mt-0">
                    <h3 className="font-semibold text-xl py-4 text-pink-500 text-opacity-100">Finding your perfect match on METRO is simple and hassle-free.</h3>
                    ...
                    <button className="mt-4 bg-pink-400 text-white py-2 px-4 rounded-lg hover:bg-pink-600">Read More ...</button>
                </div>
            </div>
        </div>
    </section>
