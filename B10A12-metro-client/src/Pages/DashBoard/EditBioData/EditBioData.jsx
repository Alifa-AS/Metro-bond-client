...
const EditBioData = ({ biodataId }) => {
  const { getBiodata, createBiodata, updateBiodata, loading, error } = useAxiosBio();
  ...
  const handleSubmit = (e) => {
    ...
    const request = biodataId ? updateBiodata(biodataId, biodata) : createBiodata(biodata);
  ...
  return (
    <div className="container mx-auto mt-10 p-5 shadow-lg rounded-lg">
      <h2 className="text-3xl font-semibold text-center mb-6 text-pink-600">Edit Biodata</h2>
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8 border-2 rounded-lg shadow-lg bg-gradient-to-r from-pink-50 via-pink-100 to-pink-200">
        ...
        <div>
          ...
          <TextInput
            ...
            className= "border-2 border-pink-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-400 p-2"
          />
        </div>
        ...
        <div>
          <Label htmlFor="expectedPartnerHeight" value="Expected Partner Height" />
          <Select
        ...
        <div className="col-span-2">
          <Button type="submit" className="w-full bg-pink-400 text-white hover:bg-pink-400">Save</Button>
        </div>
      </form>
    </div>
  );
